...
public:
	...
	void Draw(float posX, float posY, int uno, int dos, int tres) {
		...
		D3DXMatrixScaling(&Scale, uno, dos, tres);
		D3DXMatrixTranslation(&Translation, posX, posY, 0.8);
		World = Scale * Translation;

		D3DXMatrixTranspose(&constBuff.WorldMatrix, &World);

		d3dContext->UpdateSubresource(cbBuffer, 0, NULL, &constBuff, 0, 0);
