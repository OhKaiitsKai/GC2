...
Texture2D normalMap : register(t2);  //se generan los mapas de textura, registros de mapas, los buffers
...
PS_Input VS_Main(VS_Input vertex)
{
	...
	float4 worldPosition;
		...
		PS_Input vsOut = (PS_Input)0;
																														//se obtienen vertices de matriz de mundo, vista
    ...
    vsOut.tangent = normalize(tangent);
																																			//se  normaliza para darle forma a los objetos
	//Binormal
    float3 binormal;
